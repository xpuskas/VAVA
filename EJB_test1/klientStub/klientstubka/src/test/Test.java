...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		GameBeanRemote remote = (GameBeanRemote)context.lookup("ejb:/EJB2//GameBean!test.GameBeanRemote");
		
		Integer id = new Integer(28);
		
		UserDetails usr = new UserDetails("SOL»¡NY");
		
		remote.addUser(usr);
		System.out.println("Kokot je: " + remote.vratMeno(20));
	}
