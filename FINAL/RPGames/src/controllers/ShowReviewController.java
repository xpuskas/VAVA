...
/**
 * Controller class for displaying a game review. In addition to displaying the review itself, it also
 * allows the user to export the review in the PNG or PDF format.
 *
 */
public class ShowReviewController implements Initializable {
	...
	/**
	 * Sets the reference to the currently displayed review.
	 * @param displayedReview - currently displayed review
	 */
	...
	/**
	 * Populates the tab with the selected review.
	 */
	...
	/**
	 * Displays the pros of the reviewed game.
	 */
	...
	/**
	 * Displays the cons of the reviewed game.
	 */
