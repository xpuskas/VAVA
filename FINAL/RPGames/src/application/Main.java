...
import controllers.GameProfileController;
...
public class Main extends Application {
    ...
    primaryStage.setTitle(PropertyManager.getProps().getProperty("app_title"));
	...
	public void launchMainApp() throws IOException {
    	...
    	Scene scene = new Scene(pane, Integer.parseInt(PropertyManager.getProps().getProperty("default_width")), Integer.parseInt(PropertyManager.getProps().getProperty("default_height")));
        scene.getStylesheets().add("application/application.css");
    	
    	Controller c = loader.getController();
    	c.setStage(dialog); 
    	
    	dialog.setTitle(PropertyManager.getProps().getProperty("app_title"));
	 ...
	 */
	public void showAddReviewDialog(Game game, GameProfileController gpc){
    	FXMLLoader loader = new FXMLLoader();
	 ...
	 * @return
	 */
	public void showAddArticleDialog(Game game, GameProfileController gpc) {
    	FXMLLoader loader = new FXMLLoader();
